...
//				{IDcard:"620121199511131445",name:"杨静如",relation:"女儿",Sex:"女",nation:"汉族", Hnumber:"1459341712330"},
				<?php
					...
					$sql = "select IDcard,name,relation,Sex,nation,Hnumber,id from person where ordis='未注销';";
					$result = mysql_query($sql);
			...
			jQuery(function($) {
				...
				jQuery(grid_selector).jqGrid({
					...
					colModel:[
						...
						{name:'Hnumber',index:'Hnumber', width:36, sorttype:"int", editable: true},
						{name:'name',index:'name', width:17,editable: false,editoptions:{size:"20",maxlength:"30"}},
						{name:'relation',index:'relation', width:17,editable: true,editoptions:{size:"20",maxlength:"30"}},
					...
					editurl: "http://localhost/jemadmin/xiuhu.php",
					caption: "其户口信息编辑",
