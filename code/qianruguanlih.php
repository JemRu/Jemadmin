...
<![endif]-->
		...
		<script type="text/javascript">
			var grid_data = 
			[ 
				//{Number:"66973249735870185",Hname:"杨国尧",outdata:"1975-05-13",outadress:"山东济南"},
				<?php
				require "conn.inc.php";
			...
			jQuery(function($) {
				...
				jQuery(grid_selector).jqGrid({
					...
					height: 250,
					//列表属性顺序
					colNames:['','id','户号','户主','是否迁入','迁入日期','迁入地址'],
					colModel:[
						...
						{name:'Hnum',index:'Hnum', width:50, sorttype:"int", editable: false},
						{name:'Hname',index:'Hname', width:17,editable: false,editoptions:{size:"20",maxlength:"30"}},
						
						
						
						{name:'orout',index:'orout', width:20,editable: true,editoptions:{size:"20",maxlength:"30"}},
					...
					editurl: $path_base+"jemadmin/hqianru.php",//nothing is saved
					caption: "迁入户口信息编辑",
