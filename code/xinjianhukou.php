						...
						<div class="row">
							<div class="col-xs-12">
								...
								<div class="alert alert-info">
									...
									请在下方点击加号插入新增户口，离开页面时请先提交修改后的表单
		...
		<script type="text/javascript">
			...
			[ 
				<?php
					...
					$sql = "select * from account where id >= ((select max(id) from account)-4);";
					$result = mysql_query($sql);
			...
			jQuery(function($) {
				...
				jQuery(grid_selector).jqGrid({
					...
					height: 250,
					//列表属性顺序
					colNames:['','户号','户主','身份证号','户址', '户别', '登记日期', '是否迁出','是否注销','迁入日期','迁入地址'],
					colModel:[
						...
						{name:'logout',index:'logout:', width:23,editable: true,editoptions:{size:"20",maxlength:"30"}},
					...
					editurl: $path_base+"jemadmin/xinjianh.php",//nothing is saved
					caption: "此次新增户口列表",
