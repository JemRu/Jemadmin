...
<html lang="en">
	<head>
		<meta charset="utf-8" />
		<title>户籍管理系统-查询管理</title>
		<meta name="keywords" content="查询管理" />
		<meta name="description" content="查询管理" />
				...
				<div class="main-content">
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<ul class="breadcrumb">
							...
							<li>
								<a href="renkouchaxun.html">查询管理</a>
							</li>
							<li class="active">户口信息查询</li>
						</ul><!-- .breadcrumb -->
...
<![endif]-->
		...
		<script type="text/javascript">
			var grid_data = 
			[ 
//				{Hnum:"66973249735870185",Hname:"杨国尧",Adress:"甘肃兰州",Hcategory:"城镇户口",Regdata:"1975-05-13", orout:"是",Indate:"1975-05-13",InAdress:"山东济南"},
				<?php 
						require "conn.inc.php";
			...
			jQuery(function($) {
				...
				jQuery(grid_selector).jqGrid({
					...
					height: 250,
					//列表属性顺序
					colNames:['户号','户主','户址', '户别', '登记日期', '是否迁出','迁入日期','迁入地址','是否注销'],
					colModel:[
						...
						{name:'logout',index:'logout', width:20,editable: true,editoptions:{size:"20",maxlength:"30"}}
					], 
